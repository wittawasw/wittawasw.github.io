...
นอกจากการ load schema แล้วก็ยังมี `rails db:schema:dump` ที่เป็นคำสั่งตรงข้ามของการ load
โดยเป็นคำสั่งที่เอาข้อมูล schema ในฐานข้อมูลที่เชื่อมต่อลงเก็บที่ `schema.rb`
ซึ่งก็สะดวกสำหรับใช้ในการตรวจสอบว่า Database schema ตรงกับที่มีใน `schema.rb` หรือไม่
