...
---
ใจความหลักของ Agents.md ที่ผมใช้เองเป็นประจำ ใน ChatGPT, Codex, Claude ก็คือส่วนที่ให้ใส่
Personalization เน้นการใช้งานแบบที่มีการผู้ควบคุมเป็นหลัก ซึ่งผู้ควบคุม
